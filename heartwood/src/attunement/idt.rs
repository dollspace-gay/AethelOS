...
pub fn init() {
    unsafe {
        ...
        // TODO: The System Call Gate - INT 0x80
        // Disabled until we implement proper userspace. The x86_64 crate's set_handler_fn
        // is incompatible with naked functions that bypass the x86-interrupt calling convention.
        // We'll need to either:
        //   1. Use syscall/sysret instructions (MSR-based, not IDT)
        //   2. Use set_handler_addr with a properly crafted naked function
        //   3. Wait for x86_64 crate to support this use case
        // For now, no userspace exists, so INT 0x80 isn't needed.
